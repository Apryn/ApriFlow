  ...
  return (
    <div className="flex flex-col md:flex-row min-h-screen bg-zinc-950 text-zinc-50">
      ...
      <div className="flex flex-1 flex-col">
        <header className="sticky top-0 z-40 border-b-2 border-black bg-zinc-900/95 px-4 py-2.5 pt-[calc(env(safe-area-inset-top,0px)+10px)] backdrop-blur-md md:hidden flex items-center justify-between">
