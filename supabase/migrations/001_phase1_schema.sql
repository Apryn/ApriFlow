...
BEGIN
  INSERT INTO categories (user_id, name, type, expense_kind, sort_order) VALUES
    ...
    (p_user_id, 'Jajan',         'expense', 'bocor',     4),
    (p_user_id, 'Bensin',        'expense', 'wajib',     5),
    (p_user_id, 'WiFi',          'expense', 'wajib',     6),
    (p_user_id, 'Listrik',       'expense', 'wajib',     7),
    (p_user_id, 'Belanja Online','expense', 'bocor',     8),
    (p_user_id, 'Motor',         'expense', 'wajib',     9),
    (p_user_id, 'Kuliah',        'expense', 'wajib',     10),
    (p_user_id, 'Keluarga',      'expense', 'fleksibel', 11),
    (p_user_id, 'Hiburan',       'expense', 'fleksibel', 12),
    (p_user_id, 'Kesehatan',     'expense', 'wajib',     13),
    (p_user_id, 'Transfer',      'expense', 'fleksibel', 14),
    (p_user_id, 'Lain-lain',     'expense', 'fleksibel', 15);
